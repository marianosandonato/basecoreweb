...
export default function PageHero({ title, lines, image, cta }: Props) {
  return (
    <section className="relative">
      ...
      <div className="relative flex flex-col items-center justify-center px-[15px] text-center md:h-screen">
        {/* The 50px spacer is a widget in the original's stack, so it is part of
            what gets vertically centred rather than section padding. */}
