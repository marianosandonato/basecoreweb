...
export default function WhatsAppButton() {
  return (
    <a
      ...
      // instead of sliding, but that only fires on the rare visit where the language banner toggles.
      className="fixed right-5 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-whatsapp text-4xl text-white shadow-lg transition-transform duration-300 hover:scale-110 motion-reduce:transition-none bottom-[calc(1.25rem+var(--lang-banner-height,0px))]"
    >
      <WhatsAppIcon />
    </a>
  );
