...
> - Nota: se mueven acá 1.39 y 1.41 (margen del cajón "Etapas" y flip cards) — Mariano las marcó OK en el widget de revisión interactiva del Plan de SEO (ahora "BaseCoreWeb: SEO y Performance"), detalle completo movido acá. También se actualizaron los 3 links al Plan de SEO a su nueva URL.
