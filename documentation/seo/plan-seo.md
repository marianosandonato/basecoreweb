...
79 / 90 tareas · +4 bloqueadas (4.1, 4.3, 4.4, 8.4)
...
En progreso · banner en producción, textos con el abogado
...
GA4 G-0NRE1KWMBM (GtmLoader.tsx): analítica → solo tras "Aceptar"
  en el banner (eed9e24, desde el 26/9)
...
4.5.3  Banner de cookies + Consent Mode v2 básico, GA4 solo Hecho (26/9)
       tras "Aceptar", link "Configurar cookies" en el footer.
       Mariano aprobó el preview; commit eed9e24 en producción,
       verificado en vivo (sin cookies ni gtag/js antes de
       aceptar; _ga y _ga_0NRE1KWMBM después). CLS lab 0.005 → 0.019
4.5.4  Andamiaje: rutas /privacidad y /en/privacy (+        Pendiente
       cookies), links en el footer, checkbox opcional
       de marketing (desbloquea 5.3/6.2 del Marketing).
       Backend listo (sesión de la 5.1): input
       name="marketingConsent", sin marcar por defecto, en los
       dos formularios; tildado → HubSpot guarda
       consentimiento_marketing=true y la fecha. ANTES de subirlo,
       Mariano crea esas 2 propiedades en HubSpot (si no, el lead
       no entra al CRM). Si se guardan UTM entre páginas, solo
       tras "Aceptar". Sumar el link a la política en el banner
       (PRIVACY_POLICY_HREF en src/lib/consent.ts)
4.5.5  Revisión del abogado de Mariano (versión .docx en     En curso
       documentation/legal/revision-legal/, reenfocada a
       Argentina, datos del titular completos)
```

**Cruce con la 5.1 del Marketing Strategy:** formularios → HubSpot ya en producción, sin checkbox. Guardar en el CRM a quien pidió que lo contacten está justificado; mandarle newsletters o secuencias no, hasta que existan 4.5.4 y la 6.2. La política ya describe HubSpot como activo desde el 25/9.
