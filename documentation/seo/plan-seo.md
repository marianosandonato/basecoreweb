...
Pendiente, tarea recurrente · prefetch + lazy-loading implementados (21/9), esperando lectura real en producción
...
| 1.28 | Performance con PageSpeed Insights (mobile/desktop, recurrente) | Pendiente · fixes de mobile +90 en prod, esperando medir |
