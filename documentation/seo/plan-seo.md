...
4.5.6  Pendientes de Mariano antes de publicar:              Pendiente
       ...
       d) Cloudflare Web Analytics: decisión 26/9, mantenerlo.
          Redactar el párrafo para la política (medición sin
          cookies, datos técnicos de la visita) + fila en la
          tabla de proveedores, y que lo valide el abogado.
