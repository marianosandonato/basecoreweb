...
79 / 89 tareas · +4 bloqueadas (4.1, 4.3, 4.4, 4.5)
...
Fase abierta el 14/9. 8.1 se cerró el mismo día (decisión tomada: no avanzar) y 8.2 se cerró del todo el 21/9 (confirmado que la ficha de Crunchbase es de un tercero, sin nada que reclamar) — detalle completo de ambas en el [Historial Técnico SEO](https://claude.ai/code/artifact/06216aa3-06d1-4a75-a16a-f76e134cfcd8). 8.3 sigue activa, esperando decisión de Mariano.
