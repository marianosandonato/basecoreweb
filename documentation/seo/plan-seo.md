...
> - Nota 26/9 (noche, 3): auditoría técnica de trackers/cookies en producción sumada a la 4.5; cookies de GA4 ajustadas a 13 meses; párrafo de Cloudflare Web Analytics pendiente, sin redactar.
> - Nota 26/9 (noche, 2): 4.5 en suspenso por decisión de Mariano — banner retirado de producción (revert 1ead6e8), preview de 4.5.4 aprobado, pendientes de Mariano en 4.5.6 y pasos de publicación en 4.5.7. Worktree .claude/worktrees/agent-a7aeb211238a63018: NO borrar.
> - Nota 26/9 (noche): 1.42 cerrada — arreglo del header subido solo (30067e5), detalle movido al Historial. 80/91.
> - Nota 26/9 (tarde): 4.5.4 en revisión (páginas legales + checkbox en preview), 4.5.5 hecha (versión maestra del abogado), nueva 4.5.6 (pasos de Mariano antes de publicar) y nueva 1.42 (header superpuesto en páginas sin hero, fix en el mismo preview). 79/91.
> - Nota 26/9: 4.5.3 hecha — banner de cookies + Consent Mode v2 básico en producción (eed9e24), verificado en vivo. 4.5.4 suma los requisitos del backend de la 5.1 (`marketingConsent`, 2 propiedades a crear en HubSpot antes). Política/.docx actualizados con HubSpot en producción.
> - Nota 25/9 (noche, 2): 4.5 reenfocada a Argentina (Ley 25.326/AAIP principal, RGPD secundario), .docx para el abogado en `documentation/legal/revision-legal/`.
> - Nota 25/9 (noche): 4.5.2 hecha — borrador de privacidad, cookies y primera capa (ES/EN) en `documentation/legal/`.
> - Nota 25/9 (tarde): 4.5 desbloqueada a pedido de Mariano → En progreso (Activo hoy). +4 bloqueadas.
> - Nota 25/9: 1.37 cerrada del todo — fix de Turnstile.tsx (efc5266) verificado en producción, regla de rate limiting en Cloudflare verificada, detalle movido al Historial. 79/90 tareas.
> - Nota 24/9 (noche): 1.37 reabierta (Turnstile: cartel de error falso en desktop aunque verifica bien, y fallas en mobile). Vuelve a Pendiente en Activo hoy. Primera lectura del código: el temporizador de 12 s de Turnstile.tsx no se cancela al verificar. 78/90 tareas.
...
> - Nota 24/9 (tarde): 4.3 sigue Bloqueada; se sumó nota de la auditoría de backlinks hecha por `web-lead`. Resumen de la auditoría: `~/.claude/projects/-home-marian-GitHub-basecoreweb/memory/project_backlinks_4_3_auditoria.md`.
...
80 / 91 tareas · +4 bloqueadas (4.1, 4.3, 4.4, 8.4)
...
Pendiente · en suspenso por decisión de Mariano (26/9), paquete listo y aprobado
...
4.5.6  Pendientes de Mariano antes de publicar:              Pendiente
       a) Consultar a su contador: la política muestra su CUIT
          y domicilio (todavía no factura).
       b) Crear en HubSpot consentimiento_marketing (casilla
          única) y fecha_consentimiento_marketing (selector de
          fecha). Sin ellas, un lead que tilde el checkbox no
          entra al CRM.
       c) Inscribir la base en la AAIP (TAD, gratis): primero
          "Inscripción del Responsable", después "Inscripción de
          bases de datos privadas". Conviene que el abogado mire
          el formulario.
       d) Cloudflare Web Analytics: decisión 26/9, mantenerlo.
          Párrafo para la política (medición sin cookies, datos
          técnicos de la visita) + fila en la tabla de
          proveedores: PENDIENTE, sin redactar (Mariano pidió
          dejarlo así el 26/9). Lo valida el abogado.
...
4.5.7  Publicar (el día del ok de Mariano):                  Pendiente
...
| 1.37 | Turnstile: colgado en iOS y cartel de error falso (reabierta 24/9, cerrada 25/9) | Hecho |
...
| 1.42 | Header desktop superpuesto en páginas sin hero (blog, legales, 404) | Hecho |
...
| 4.5 | Política de privacidad (GDPR/LOPDGDD) | En progreso |
...
**Auditoría hecha (24/9):** Mariano pidió desbloquearla y `web-lead` corrió una auditoría completa (diagnóstico: cero backlinks; pre-requisitos on-site como página "Sobre nosotros" y un activo linkable sin gate; plan por fases con directorios, reciprocidad con clientes, partner CRM, digital PR/podcasts y cámaras; propuesta de subtareas 4.3.1-4.3.7). Ese mismo día Mariano decidió dejarla Bloqueada por otras prioridades. Al retomarla, partir de esa auditoría en vez de relanzarla — el resumen quedó guardado en la memoria del proyecto de la sesión principal.
