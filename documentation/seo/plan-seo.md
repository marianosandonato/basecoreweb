...
73 / 87 tareas · 2 en progreso (1.25, 8.2) · +4 bloqueadas (4.1, 4.3, 4.4, 4.5) · +1 pendiente de revisión en Fase 1 (1.40, ronda 2 implementada 20/9)
...
**Ronda 1 (19/9):** `overlayOpacity` bajado a 0.112 (20% relativo menos que el default de `PageHero`, 0.14). Verificado visualmente y confirmado en el HTML servido en vivo. Commit `f2fdf02`. **Mariano lo revisó y marcó "No"** en el widget de revisión: "sigue estando muy azul, corregir".

**Ronda 2 (20/9):** se compararon 0.06/0.08/0.112 en vivo con Playwright antes de elegir — 0.08 deja la foto claramente más presente que 0.112 sin perder legibilidad del H1 blanco, que sí se resentía en 0.06. Aplicado en ES y EN, confirmado en el HTML servido en vivo de basecoresales.com/marketing. Commit `cc7cb8e`.
