...
<div class="task">
<div class="task-top"><div class="task-title">8.2 — Visibilidad de marca: no aparece buscando "Base Core" solo</div><span class="chip progress"><span class="dot"></span>En progreso · #1/#2/#4 en producción, #7 sin confirmar</span></div>
...
<footer class="note">
Última actualización: 2026-09-14 (Fase 8 "Base Core en motores de búsqueda": 8.1 naming en pausa, 8.2 con #1/#2 (alternateName + llms.txt, PR #41) mergeados y confirmados en producción, #4 (chequeo mensual) establecido; antes, el mismo día, se resolvió el acceso a GA4 para 1.25 y se cerraron los 6 hallazgos de la auditoría del 13/9) · se irá marcando como Hecho a medida que avancemos.
</footer>
</div>
</body></html>