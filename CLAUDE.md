...
- **Performance Web** — eliminado el 21/9. Archivado el 12/9 (el seguimiento operativo de performance ya vivía en el Plan de SEO, Fase 1, 1.23 en adelante); el 21/9 se consolidó su detalle técnico completo (mediciones reales, commits, método, hallazgos descartados) al Historial Técnico SEO (tareas 1.14, 1.23-1.27) y se eliminó el artifact por no quedarle contenido propio — mismo criterio Camino B que ya se aplicó con Auditoría Final/Auditoría General. Ya no hay link vivo: el detalle de performance ya cerrado vive en el Historial Técnico SEO, con espejo en `documentation/seo/historial-seo.md`.
